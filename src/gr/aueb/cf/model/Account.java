...
public class Account extends IdentifiableEntry {
    private User holder;
    private String iban;
     ...
     * @throws SssNotValidException
     * @throws NegativeAmountException
     */


    public void withdraw(double amount, String ssn) throws
            InsufficientBalanceException, SssNotValidException, NegativeAmountException {
        ...
        try {
            ...
            balance -= amount;
        } catch (InsufficientBalanceException | SssNotValidException | NegativeAmountException e) {
